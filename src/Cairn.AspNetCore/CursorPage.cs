...
/// <param name="Prev">The cursor for the previous page, or <see langword="null"/> if there is none.</param>
public sealed record CursorPage<T>(
    IReadOnlyList<T> Items,
    [property: JsonIgnore] string? Next = null,
    [property: JsonIgnore] string? Prev = null) : ICursorPagedResource
{
...
/// <param name="Next">The cursor for the next page, or <see langword="null"/> if there is none.</param>
/// <param name="Prev">The cursor for the previous page, or <see langword="null"/> if there is none.</param>
public readonly record struct CursorView(IEnumerable Items, string? Next, string? Prev);

...
/// pagination-binding, and deprecation markers do not depend on the link provider.
/// </summary>
internal sealed class CairnSwaggerOperationFilter(IServiceProvider services) : IOperationFilter
{
    public void Apply(OpenApiOperation operation, OperationFilterContext context)
    {
        ...
        HypermediaJsonSchemas.DocumentPaginationBinding(context.ApiDescription, operation);

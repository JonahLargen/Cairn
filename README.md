...
| [`Cairn.Templates`](https://www.nuget.org/packages/Cairn.Templates) | `dotnet new cairn-api` — scaffolds a minimal API wired for hypermedia. Installed with `dotnet new install`. | net8.0 · net9.0 · net10.0 |
